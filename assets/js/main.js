document.addEventListener("DOMContentLoaded", () => {
    ...
    const sliderContent = [
        { name: "Serene Space", img: './assets/images/img1.jpg' },
        { name: "Gentle Horizon", img: './assets/images/img2.jpg' },
        { name: "Quiet Flow", img: './assets/images/img3.jpg' },
        { name: "Ethereal Light", img: './assets/images/img4.jpg' },
        { name: "Calm Drift", img: './assets/images/img5.jpg' },
        { name: "Subtle Balance", img: './assets/images/img6.jpg' },
        { name: "Soft Whisper", img: './assets/images/img7.jpg' }
    ];
    ...
    function createAndAnimateTitle(content, direction) {
        ...
        gsap.set(newTitle.querySelectorAll("span"), {
            y: yOffset
        });
